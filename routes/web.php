...
Route::get('user/subkategori/sub', function () {
    return view('user/subkategori/sub', [
        "title" =>" Golongan 1"
    ]);
});

Route::get('user/kategori/kendaraan', function () {
    return view('user/kategori/kendaraan', [
        "title" =>" Kendaraan kecil"
    ]);
});
...
Route::get('user/kategori/detail', function () {
